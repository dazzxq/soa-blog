...
- [x] 03-03-PLAN.md — Wave 2: gateway D-01 invariant (self/404/409/503-then-write) + enriched lists/suggestions (email allowlist) + ConnectionClient + routes/DI; lights up /full
- [x] 03-04-PLAN.md — Wave 3: UI connections.html + profile.html relationship badge/actions (Vietnamese, minimal)
...
**Plans**: 4 plans
Plans:
- [ ] 06-01-PLAN.md — Wave 1: scripts/smoke-phase6.sh (Wave 0 infra) + brand navy tokens (styles.css) + window.proNav() shared navbar (app.js)
...
| 6. Giao diện ProConnect | 0/4 | Not started | - |
